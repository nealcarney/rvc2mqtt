...
class TESTER_THERMOSTAT_STATUS_1(EntityPluginBaseClass):
    FACTORY_MATCH_ATTRIBUTES = {"name": "THERMOSTAT_STATUS_1", "type": "test"}
    """
    A test thermostat entity
    """

    def __init__(self, floorplan_info: dict, mqtt_support: MQTT_Support):
        self.id = "test-i" + str(floorplan_info["instance"])
